...
extension SSHKeyExchangeStateMachine {
    ...
    static let supportedKeyExchangeImplementations: [EllipticCurveKeyExchangeProtocol.Type] = [
        ...
        // Fork addition: legacy fallback for servers too old to offer ECDH
    ...
    static let supportedServerHostKeyAlgorithms: [Substring] = [
        ...
        // Fork addition: legacy fallback for servers too old to have an
        // ed25519/ECDSA host key (see NIOSSHPublicKey.BackingKey.rsa).
        // Listed last so a modern host key is always preferred when the
        // peer has one.
        "ssh-rsa",
    ]
}
